...
import { User, Mail, Lock, ShieldCheck, Eye, EyeOff, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="bg-white rounded-[2rem] border border-[#EAEDF2] shadow-[0_15px_40px_rgba(0,0,0,0.04)] p-8 md:p-10 relative overflow-hidden transition-all duration-300 hover:shadow-[0_20px_50px_rgba(0,0,0,0.06)]">
      ...
      <div className="flex flex-col items-center text-center mb-8">
        ...
        <h1 className="text-2xl font-extrabold text-brand-dark tracking-tight font-sans">Create Account</h1>
        <p className="text-sm font-semibold text-brand-text-muted mt-1">Get started with your VedaAI classroom assistant</p>
      </div>
      ...
      <form onSubmit={submit} className="space-y-5">
        ...
        <div className="space-y-1.5">
          <label className="block text-sm font-semibold text-brand-dark font-sans">Name</label>
        ...
        <div className="space-y-1.5">
          <label className="block text-sm font-semibold text-brand-dark font-sans">Confirm Password</label>
          <div className="relative group">
            <div className="absolute left-4 top-3.5 text-brand-text-muted group-focus-within:text-brand-orange transition-colors duration-200">
              <Lock className="w-5 h-5" />
            </div>
        ...
        <p className="text-center text-sm text-brand-text-muted mt-6">
          ...
          <a href="/login" className="text-brand-dark hover:text-brand-orange font-bold transition-colors duration-200 underline decoration-2 decoration-brand-orange/30 hover:decoration-brand-orange">
            Sign in
          </a>
        </p>
      </form>
